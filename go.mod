module github.com/ai-research-platform

go 1.25.0

replace github.com/ai-research-platform/internal => ./src/internal

require (
	github.com/ai-research-platform/internal v0.0.0-00010101000000-000000000000
	github.com/cloudwego/eino v0.7.3
	github.com/cloudwego/eino-ext/components/model/deepseek v0.0.0-20251201051757-182503179fca
